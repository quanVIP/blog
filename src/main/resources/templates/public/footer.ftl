        ...
        <div class="row">
            <div class="col-lg-6 text-center text-lg-left my-auto">
                <ul class="list-inline mb-2 text-white">
                    ...
                    <li class="list-inline-item">&sdot;</li>
                    <li class="list-inline-item">
                        <a href="https://github.com/quanVIP" target="_blank" class="text-white">Github 项目</a>
                    </li>
                </ul>
            ...
            <div class="col-lg-6 text-center text-lg-right my-auto">
                ...
                <#-- github -->
                    <li class="list-inline-item mr-3">
                        <a href="https://github.com/quanVIP" target="_blank" class="text-white">
                            <i class="fa fa-github fa-2x fa-fw"></i>
                        </a>
                    </li>
                <#-- qq -->
                    <li class="list-inline-item mr-3">
                        <a href="tencent://message/?uin=947297456&Site=在线QQ&amp;Menu=yes" class="text-white">
                            <i class="fa fa-qq fa-2x fa-fw"></i>
                        </a>
                    </li>
                <#-- wechat -->
                    <img id="id_img_wechat_qrcode" src="/img/wechat.png" alt="Wechat" class="img_shadow"
